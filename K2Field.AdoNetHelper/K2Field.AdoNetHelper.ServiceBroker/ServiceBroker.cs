...
namespace K2Field.AdoNetHelper.ServiceBroker
{
    public class ServiceBroker : ServiceAssemblyBase, IHostableType
    {
        ...
        {
            Service.ServiceConfiguration.Add(ServiceConfig.ServiceObjectsDefinition, true,
                "[{\"SoName\": \"So_1\",\"Properties\":[{\"Name\":\"Prop1\",\"Type\":\"Text\"},{\"Name\":\"Prop2\",\"Type\":\"Number\"}]},{\"SoName\": \"So_2\",\"Properties\":[{\"Name\":\"Prop1\",\"Type\":\"Text\"},{\"Name\":\"Prop2\",\"Type\":\"Number\"}]}]");
        ...
        public override string DescribeSchema()
        {
            ...
            Service.Name = "K2Field.AdoNetHelper.ServiceBroker";
            Service.MetaData.DisplayName = "K2Field_AdoNetHelper_ServiceBroker";
            Service.MetaData.Description = "A Service Broker that provides some useful functionality when working with Ado.Net queries and various SMO.";
